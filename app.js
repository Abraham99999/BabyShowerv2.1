const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxoGBaeZDPZdDFAXx8Wy-gmSU9zmT-r8p3xszEDp10pQ41QZIaunCkoh754NEP0lUDzVw/exec";
...
async function enviarRespuesta(estado) {
    ...
    const asistente =
        document.getElementById('asistente').value.trim();
...
document
    ...
    .addEventListener('click',
        () => enviarRespuesta('Asiste'));

document
    .getElementById('noAsistoBtn')
    .addEventListener('click',
        () => enviarRespuesta('No asiste'));
